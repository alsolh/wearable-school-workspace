		...
		(function(){
			...
			page.addEventListener("pagebeforeshow", function() {
				...
				function submitAnswer(selectedAnswer) {
					console.log(JSON.stringify(questionObject[selectedAnswer[0]]));
					console.log(selectedAnswer);
					    localStorage["question"]=JSON.stringify(questionObject[selectedAnswer[0]]);
				...
				element.addEventListener('click', function() { 
				    ...
				    var myStringArray = questionObject;
